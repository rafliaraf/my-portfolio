          ...
          <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left" data-aos="fade-left">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3.5 mt-8">
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-red-600 hover:bg-red-500 text-white text-sm font-semibold shadow-[0_0_20px_rgba(220,38,38,0.35)] transition-all duration-300 flex items-center gap-2"
              >
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-neutral-900/90 hover:bg-neutral-800 text-neutral-300 hover:text-white text-sm font-semibold border border-neutral-800 transition-all duration-300"
              >
                Work Experience
              </button>
              ...
              <a
                ...
                className="px-4 py-2.5 rounded-xl bg-neutral-900/90 hover:bg-neutral-800 text-neutral-400 hover:text-white border border-neutral-800 text-xs font-semibold flex items-center gap-2 transition-colors"
